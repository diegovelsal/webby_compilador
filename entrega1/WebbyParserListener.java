...
public interface WebbyParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link WebbyParser#tipo}.
	 * @param ctx the parse tree
	 */
	void enterTipo(WebbyParser.TipoContext ctx);
	/**
	 * Exit a parse tree produced by {@link WebbyParser#tipo}.
	 * @param ctx the parse tree
	 */
	void exitTipo(WebbyParser.TipoContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link WebbyParser#print_stmt}.
	 * @param ctx the parse tree
	 */
	void enterPrint_stmt(WebbyParser.Print_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link WebbyParser#print_stmt}.
	 * @param ctx the parse tree
	 */
	void exitPrint_stmt(WebbyParser.Print_stmtContext ctx);
	/**
